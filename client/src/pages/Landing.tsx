    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-gray-900 dark:via-blue-900 dark:to-indigo-900">
      ...
      <section className="container mx-auto px-4 py-16 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 mb-12 leading-relaxed max-w-3xl mx-auto">
            Step into a new era of decision-making with Causal AI, the generative AI platform that empowers you to 
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">
            Why Choose Causal AI?
          </h2>
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            Whether you're optimizing business operations, planning resource allocation, or preparing for 
            unexpected events, Causal AI gives you the tools to visualize multiple possible futures.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          ...
          <Card className="border-0 shadow-lg bg-white/60 backdrop-blur-sm dark:bg-gray-800/60">
            ...
            <CardContent>
              <p className="text-gray-600 dark:text-gray-300">
                Causal AI models cause-and-effect relationships to reveal how your interventions 
      ...
      <section className="bg-white/50 dark:bg-gray-800/50 py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">
              Causal AI Adapts to Your World
            </h2>
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              From finance and investment to logistics, operations, and crisis management—
              Causal AI transforms decision-making across every industry.
            </p>
          </div>
      ...
      <section className="container mx-auto px-4 py-16 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 mb-12 max-w-3xl mx-auto">
            Join forward-thinking organizations already using Causal AI to make better decisions, 
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="flex items-center gap-3 mb-4 md:mb-0">
              ...
              <div>
                <h3 className="font-bold">Causal AI</h3>
            ...
            <div className="text-center md:text-right">
              ...
              <p className="text-gray-500 text-xs">
                © 2025 Causal AI. Powered by advanced T-NCM-VAE technology.
              </p>
            </div>
          </div>
        </div>
